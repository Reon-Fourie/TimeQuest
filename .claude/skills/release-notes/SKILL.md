---
name: release-notes
description: Generates TimeQuest release notes from a list of signed-off features / fixes. Groups items into New Features / Improvements / Bug Fixes / Infrastructure-Technical, captures testing summary, and includes a sign-off block. Only includes items the user confirms are tested and signed off.
---
